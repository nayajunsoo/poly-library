...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .form-group input { width: 100%; padding: 11px 14px; border: 1.5px solid #D4B896; border-radius: 6px; font-size: 14px; font-family: inherit; background: #FFFDF8; color: #3B2F2F; transition: border-color 0.2s; }
  .form-group input:focus { outline: none; border-color: #A0522D; background: #FFF8F0; }
  ...
  <div class="form-card">
    <form action="/poly-library/book/bookRegister.do" method="post">
      <div class="form-group">
        ...
        <input type="text" id="title" name="title" placeholder="도서명을 입력하세요" required />
      </div>
      <div class="form-group">
        <label for="author">저자 *</label>
        <input type="text" id="author" name="author" placeholder="저자명을 입력하세요" required />
      </div>
      <div class="form-group">

...
<script>
  var msg = "${msg}";
  if (msg && msg !== "" && msg !== "null") { alert(decodeURIComponent(msg.replace(/\+/g,' '))); }
</script>
<style>
...
<div class="login-container">
  <div class="login-card">
    ...
    <div class="login-footer">
      아직 회원이 아니신가요?
      <a href="${pageContext.request.contextPath}/user/joinView.do?returnUrl=${returnUrl}">회원가입 하기</a>
    </div>

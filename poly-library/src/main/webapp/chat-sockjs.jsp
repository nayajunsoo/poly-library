...
<body>
	Server URL : <input type="text" id="serverUrl" value="ws://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}" style="width:400px;">* localhost not specified(Must be IP)<br/>
